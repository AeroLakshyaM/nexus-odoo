...
export default function UserProfilePage() {
  ...
  const background = useTransform(x, [-100, 0, 100], ["#ef4444", "#3b82f6", "#10b981"])
    ...
    >
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-8">
          <div className={`rounded-2xl p-6 ${isDarkMode ? "bg-black/60 border border-white/20" : "bg-white/80 border border-gray-200"}`}>
              ...
              <div className="text-center md:text-left flex-1">
                ...
                <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                  ...
                  <div className="text-center">
                    ...
                    <div className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>Followers</div>
                  </div>
                  <div className="text-center">
                    <div className={`text-2xl font-bold ${isDarkMode ? "text-white" : "text-gray-900"}`}>
        ...
        <motion.div variants={itemVariants} className="mb-6">
          <div className={`rounded-xl p-1 ${isDarkMode ? "bg-black/60 border border-white/20" : "bg-white/80 border border-gray-200"}`}>
            <div className="flex">
              {tabs.map((tab) => (
                <button
                  key={tab}
            ...
            {activeTab === "overview" && (
              <div className="grid lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                  <div className={`rounded-xl p-6 ${isDarkMode ? "bg-black/60 border border-white/20" : "bg-white/80 border border-gray-200"}`}>
                ...
                <div className="space-y-6">
                  ...
                  <div className={`rounded-xl p-6 ${isDarkMode ? "bg-black/60 border border-white/20" : "bg-white/80 border border-gray-200"}`}>
                    ...
                    <div className="space-y-3">
                      <div className={`flex items-center gap-3 p-2 rounded-lg transition-colors ${isDarkMode ? "text-gray-300 hover:bg-gray-800" : "text-gray-700 hover:bg-gray-100"}`}>
                ...
                <div className="space-y-6">
                  {profileData.experience.map((exp, index) => (
                    ...
                    >
                      ...
                      <h5 className={`text-md font-medium mb-2 ${isDarkMode ? "text-blue-400" : "text-blue-600"}`}>
                        {exp.company}
                      </h5>
